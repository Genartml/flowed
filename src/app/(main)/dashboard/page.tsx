...
export default function DashboardPage() {
  ...
  const { sharedConfig, entityConfig, updateTotalFunds, updateMonthlyIncome, updateCompanySettings } =
    ...
    <div className="min-h-full pb-24 page-fade-in">
      ...
      <div className="p-4 md:p-8 max-w-[1200px] mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <button
            ...
            className="flex items-center gap-4 bg-zinc-900 border border-zinc-800 hover:border-emerald-500 hover:shadow-[0_0_30px_-5px_rgba(16,185,129,0.3)] transition-all p-5 rounded-2xl group text-left relative overflow-hidden"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <button
            ...
            className="flex items-center gap-4 bg-zinc-900 border border-zinc-800 hover:border-blue-500 hover:shadow-[0_0_30px_-5px_rgba(59,130,246,0.3)] transition-all p-5 rounded-2xl group text-left relative overflow-hidden"
          >
          ...
          <button
            ...
            className="flex items-center gap-4 bg-zinc-900 border border-zinc-800 hover:border-zinc-500 hover:bg-zinc-800/80 transition-all p-5 rounded-2xl group text-left"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="border border-zinc-800 bg-zinc-900 rounded-2xl shadow-sm flex flex-col h-[500px] overflow-hidden">
            <div className="px-6 py-5 border-b border-zinc-800 flex justify-between items-center bg-zinc-900">
              <h2 className="text-lg font-bold text-zinc-100">Ledger History</h2>
              <Link href="/ledger" className="text-sm font-semibold text-zinc-500 hover:text-emerald-400 transition-colors">View Full Ledger →</Link>
            </div>
            <div className="flex-1 overflow-hidden">
               {/* We just hide the input forms in the dashboard view so it's clean */}
               <MoneyMovementLog 
      ...
      <MoneyInModal 
        ...
        onConfirm={async (name, amount) => {
          updateTotalFunds(metrics.totalFunds + amount);
          await addMoneyIn(name, amount, "Other", "");
        }} 
      />
      ...
      <ManualExpenseModal 
        ...
        onConfirm={async (name, amount) => {
          updateTotalFunds(metrics.totalFunds - amount);
          await addMoneyOut(name, amount, "Other", "Manual entry", false);
        }} 
      />
      ...
      <CompanySettingsModal
        ...
        initialName={sharedConfig.companyName || "Flowwled"}
